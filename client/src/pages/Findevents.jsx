...
import { FiMoon, FiSun } from 'react-icons/fi'; // Moon and Sun icons for toggle
...
const Findevents = () => {
  ...
  return (
    <div
      id="findevents"
      className={`relative min-h-screen py-16 px-4 overflow-hidden ${isDarkMode ? 'bg-black text-white' : 'bg-white text-black'}`}
    >
      {/* Dark/Light Mode Toggle Button */}
      <div
        className="absolute top-4 right-4 bg-gray-800 text-white p-2 rounded-full cursor-pointer hover:bg-gray-700"
        onClick={toggleMode}
      >
        {isDarkMode ? (
          <FiSun size={24} />
