...
const Roadmap = () => {
  ...
  return (
    <div id="roadmap" className="bg-white text-black min-h-screen flex flex-col items-center justify-center pt-24 lg:pt-0 relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full max-w-4xl mx-auto relative z-20">
        {boxData.map((box, index) => (
          <div
            key={index}
            className="bg-white border border-gray-300 p-4 rounded-lg shadow-lg flex flex-col items-center justify-center transition-transform transform hover:scale-105 hover:border-purple-500 max-w-xs mx-auto sm:max-w-sm lg:max-w-md cursor-pointer"
      ...
      {selectedBox !== null && (
        <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-30">
          <div className="bg-white p-6 rounded-lg max-w-md w-full relative flex flex-col">
